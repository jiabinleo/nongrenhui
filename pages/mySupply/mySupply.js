...
Page({
  ...
  getData(id) {
    wx.request({
      url: "https://wxapi.nongrenhui.com/nongren_api/index.php?c=supply&a=supplyDetail&supply_id=" + id,
      header: {
  ...
  save: function () {
    ...
    if (!data.title) {
      ...
      wx.request({
        url: "https://wxapi.nongrenhui.com/nongren_api/index.php?c=supply&a=editSupply",
        method: "POST",
        header: {

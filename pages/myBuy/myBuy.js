...
Page({
  ...
  getData(id) {
    wx.request({
      url: "https://wxapi.nongrenhui.com/nongren_api/index.php?c=demand&a=demandDetail&demand_id=" + id,
      header: {
  ...
  save: function () {
    ...
    if (!data.title) {
      ...
      wx.request({
        url: "https://wxapi.nongrenhui.com/nongren_api/index.php?c=demand&a=editDemand",
        method: "POST",
        header: {
